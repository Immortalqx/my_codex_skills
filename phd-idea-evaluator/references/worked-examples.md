...
These worked examples were adapted from the source material used when the skill was originally assembled. The exact upstream study notes are not required for using this skill.
...
Probe score: 5. Disruptive seeds present. Revisit `paradigm-shift-probe.md` to strengthen the framing around "workflow as a first-class object".
...
Probe score: 5. Disruptive seeds. Revisit `paradigm-shift-probe.md` to strengthen the First Principles framing.
