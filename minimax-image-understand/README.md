...
Use this skill when Codex's built-in MCP integration is broken and the user wants to understand a specific image (describe, analyze, OCR). Triggers: "describe this image", "what's in this image", "OCR this", "read the text in this image", "analyze this picture", "caption this".
