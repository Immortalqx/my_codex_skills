...
Benchmark papers are a separate category; use `phd-benchmark-paper-template`.
...
1. Is the paper's primary contribution a benchmark? If yes, stop and redirect to `phd-benchmark-paper-template`.
