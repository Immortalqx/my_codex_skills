...
- The user wants to evaluate research direction. Use `phd-idea-evaluator` (see `phd-idea-evaluator` and its reference files for deeper disruptive-innovation evaluation).
